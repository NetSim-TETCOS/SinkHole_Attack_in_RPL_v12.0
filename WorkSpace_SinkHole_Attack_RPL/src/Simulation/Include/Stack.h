...
enum enum_MACProtocol
{
	...
	MAC_PROTOCOL_UWAN,				// Underwater acoutics network. Not really a protocol
};
...
enum enum_InterfaceType
{
	...
	INTERFACE_LTE_NR,		//LTE-NR Interface
...
struct stru_NetSim_ApplicationLayer
{
	...
	UINT* nAppProtocol; //Application layer protocol list
...
_declspec(dllexport) PROP_MEDIUM fn_NetSim_Config_GetPropagationMedium(char* med);
...
//Default config property reader
_declspec(dllexport) void fn_NetSim_Config_read_CustomFrequency(double* var,
																void* xmlNetSimNode,
																char* name,
																double defaultval);
_declspec(dllexport) void fn_NetSim_Config_read_bandwidth(double* bandwidth,
														  void* xmlNetSimNode,
														  double defaultBandwidth);
_declspec(dllexport) void fn_NetSim_Config_read_dataRate(double* dataRate,
														 void* xmlNetSimNode,
														 double defaultDataRate);
_declspec(dllexport) void fn_NetSim_Config_read_frequency(double* frequency,
														  void* xmlNetSimNode,
														  double defaultFrequency);
_declspec(dllexport) void fn_NetSim_Config_read_txPower(double* txPower,
														void* xmlNetSimNode,
